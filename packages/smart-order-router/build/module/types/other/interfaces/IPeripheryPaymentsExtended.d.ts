...
export interface IPeripheryPaymentsExtendedInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "pull" | "refundETH" | "sweepToken(address,uint256,address)" | "sweepToken(address,uint256)" | "unwrapWETH9(uint256,address)" | "unwrapWETH9(uint256)" | "wrapETH"): FunctionFragment;
