...
export interface MixedRouteQuoterV1Interface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "WETH9" | "factory" | "factoryV2" | "quoteExactInput" | "quoteExactInputSingleV2" | "quoteExactInputSingleV3" | "uniswapV3SwapCallback"): FunctionFragment;
...
export interface MixedRouteQuoterV1 extends BaseContract {
    ...
    functions: {
        ...
        uniswapV3SwapCallback(amount0Delta: BigNumberish, amount1Delta: BigNumberish, path: BytesLike, overrides?: CallOverrides): Promise<[void]>;
    };
    WETH9(overrides?: CallOverrides): Promise<string>;
    factory(overrides?: CallOverrides): Promise<string>;
    factoryV2(overrides?: CallOverrides): Promise<string>;
    ...
    estimateGas: {
        ...
        uniswapV3SwapCallback(amount0Delta: BigNumberish, amount1Delta: BigNumberish, path: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        ...
        quoteExactInputSingleV2(params: IMixedRouteQuoterV1.QuoteExactInputSingleV2ParamsStruct, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        quoteExactInputSingleV3(params: IMixedRouteQuoterV1.QuoteExactInputSingleV3ParamsStruct, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        uniswapV3SwapCallback(amount0Delta: BigNumberish, amount1Delta: BigNumberish, path: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
