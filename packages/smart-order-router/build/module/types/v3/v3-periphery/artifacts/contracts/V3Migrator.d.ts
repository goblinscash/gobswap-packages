...
export interface V3MigratorInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "WETH9" | "createAndInitializePoolIfNecessary" | "factory" | "migrate" | "multicall" | "nonfungiblePositionManager" | "selfPermit" | "selfPermitAllowed" | "selfPermitAllowedIfNecessary" | "selfPermitIfNecessary"): FunctionFragment;
